...
def best_times(event_id):
    ...
    for conflict in conflicts:
        ...
        if conflict_start.year < start.year or conflict_start.month < start.month or conflict_start.day < start.day or conflict_start.hour < start.hour or conflict_start.hour < start.hour or conflict_start.minute < start.minute:
            conflict_start = datetime.datetime(conflict_start, conflict_start, conflict_start, start_time.hour, start_time.minute)
